...
#                 <p>Duration: {stats.to_dict()['duration_minutes']:.2f} minutes</p>
#             </div>
            
#             <div class="stats">
#                 <div class="stat-box">
#                     <h3>{stats.pages_crawled}</h3>
#                     <p>Pages Crawled</p>
#                 </div>
#                 <div class="stat-box">
#                     <h3>{stats.pdfs_found}</h3>
#                     <p>PDFs Found</p>
#                 </div>
#                 <div class="stat-box">
#                     <h3>{stats.pdfs_downloaded}</h3>
#                     <p>PDFs Downloaded</p>
#                 </div>
#                 <div class="stat-box">
#                     <h3>{stats.duplicates_skipped}</h3>
#                     <p>Duplicates Skipped</p>
#                 </div>
#                 <div class="stat-box">
#                     <h3>{len(stats.errors)}</h3>
#                     <p>Errors</p>
#                 </div>
#             </div>
            
#             {"<div class='errors'><h2>Errors</h2>" + "".join([f"<div class='error-item'><strong>URL:</strong> {error['url']}<br><strong>Error:</strong> {error['error']}<br><strong>Time:</strong> {error['timestamp']}</div>" for error in stats.errors]) + "</div>" if stats.errors else ""}
#         </body>
#         </html>
#         """
...
#     @staticmethod
#     def generate_json_report(stats) -> str:
