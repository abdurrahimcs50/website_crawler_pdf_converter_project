...
#         if not is_valid_url(url,base_domain,config.EXCLUDED_KEYWORDS,config.ALLOWED_EXTENSIONS):
#             return
#         # Mark URL as visited
...
#                     for link in links:
#                         if link not in visited and is_valid_url(
#                             link,
#                             base_domain,
